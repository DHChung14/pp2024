...
import os
import curses
from input import input_students, input_courses, input_marks, compress_data, decompress_data
...
def main(stdscr):
    ...
    if data:
        ...
        system.students, system.courses, system.marks = data
    else:
        ...
        compress_data(system.students, system.courses, system.marks)
