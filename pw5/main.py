...
import os
import curses
from input import input_students, input_courses, input_marks, compress_files, decompress_files, load_data_from_files
...
def main(stdscr):
    ...
    if os.path.exists('students.dat'):
        ...
        decompress_files()
        system.students, system.courses, system.marks = load_data_from_files()
    else:
        # Input data if no compressed file exists
        ...
        # Compress the files after input
        compress_files()
